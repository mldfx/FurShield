...
const HealthRecords = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("petHealthRecords", JSON.stringify(updatedRecords));
    ...
    <div className="healthRecords-page">
      ...
      <div className="healthRecords-container">
        ...
        <div className="healthRecords-intro">
          ...
          <p>
            Track vaccinations, treatments, and important health milestones all
            in one place. Your furry friend's wellness journey starts here.
          </p>
        </div>
          ...
          <div className="healthRecords-records-grid">
            {records.length === 0 ? (
              <div className="healthRecords-empty-state">
                ...
                <p>
                  Start by adding your pet's first health record above. Every
                  vaccination, checkup, and treatment helps keep track of their
                  wellness journey!
                </p>
              </div>
            ) : (
                ...
                .map((rec) => (
                  <div key={rec.id} className="healthRecords-record-card">
                    ...
                    <div className="healthRecords-record-content">
                      ...
                      <p className="healthRecords-record-description">
                        {rec.description}
                      </p>
                    </div>
                  </div>
        ...
        {records.length > 0 && (
          <div className="healthRecords-tip">
            <Heart size={16} />
            <span>
              Great job keeping track of your pet's health! Regular
              record-keeping helps vets provide better care.
            </span>
          </div>
        )}
      </div>
